...
if __name__ == "__main__":
    ...
    data_pairs = [
        ...
        # zero-shot NER
        ["ent_movie", "resources/Mirror/MIT_MOVIE_Review/instructed/test.jsonl"],
        ["ent_restaurant", "resources/Mirror/MIT_Restaurant_Review/instructed/test.jsonl"],
        ["ent_ai", "resources/Mirror/CrossNER_AI/instructed/test.jsonl"],
        ["ent_literature", "resources/Mirror/CrossNER_literature/instructed/test.jsonl"],
        ["ent_music", "resources/Mirror/CrossNER_music/instructed/test.jsonl"],
        ["ent_politics", "resources/Mirror/CrossNER_politics/instructed/test.jsonl"],
        ["ent_science", "resources/Mirror/CrossNER_science/instructed/test.jsonl"],
        # # mrc
