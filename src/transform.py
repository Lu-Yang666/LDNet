...
class CachedLabelPointerTransform(CachedTransformOneBase):
    ...
    def transform(self, instance: dict, **kwargs):
        ...
        if "ent" in instance["ans"]:
            for ent in instance["ans"]["ent"]:
                ...
                # bce_label_spans.append(label_part[0])
        ...
        if "hyper_rel" in instance["ans"]:
            ...
            for rel in instance["ans"]["hyper_rel"]:
                ...
                for q in rel["qualifiers"]:
                    ...
                    # bce_label_spans.append(q_label_part[0])
        if "event" in instance["ans"]:
            ...
            for event in instance["ans"]["event"]:
                ...
                # bce_label_spans.append(event_type_label_part[0])
                for arg in event["args"]:
                    ...
                    # bce_label_spans.append(role_label_part[0])
        # import pdb
        # pdb.set_trace()
        schema_label_spans = []
    ...
    def skip_consecutive_span_labels(self, data: dict) -> dict:
        ...
        for i in range(bs):
            ...
            data["bce_labels"][i] = data["bce_labels"][i][:batch_seq_len]
            data["bce_mask"][i] = data["bce_mask"][i][:batch_seq_len]
            ...
            data["bce_labels"][i] = (
                data["bce_labels"][i] + [-100] * pad_len
            )
            data["bce_mask"][i] = (
                data["bce_mask"][i] +[False] * pad_len
            )
